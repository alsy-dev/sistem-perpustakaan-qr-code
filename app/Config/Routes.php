...
$routes->get('/api/peminjaman/all', 'API::peminjaman_list');
$routes->get('/api/peminjaman/(:num)', 'API::peminjaman/$1');

$routes->get('/api/member/(:num)', 'API::member/$1');

$routes->get('/api/peminjaman/all', 'API::peminjaman_list');

$routes->get('/api/recommendation/(:num)', 'API::recommend/$1');

$routes->get('/api/pjaprul', 'API::manggil_japrul');
